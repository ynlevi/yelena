...
function Recommendation() {
  return (
    <div className="lg:border-r-[.1px] border-gray-600 ">
      ...
      <ul className="snap-mandatory scroll-p-9 flex gap-6 lg:gap-9 py-6 overflow-scroll px-[2.25rem] snap-x">
        {recomms.map(({ name, city, avatar, p }) => (
          <li className="  snap-center border-theme-light-dark min-w-full font-light sm:min-w-[66%] md:min-w-[30%] py-4 px-10 text-center flex flex-col gap-4 tracking-wider text-[.9rem] border-2">
